...
/*	float eps = 0.1; */
	...
	if (default_conf) {
		printf("default: verbose = 0, print_graph = 0, print_structures = 0, gamma = 0.5, 0.2 ó 0.1), épsilon = 0.2, 0.15 ó 0.01.\n");
	} else {
		printf("\nverbose? (1 ó 0)\n");
		printf("1, modificar el .c para cambiar esto\n");
		printf("\nprint_graph? (1 ó 0)\n");
		scanf("%i", &print_graph);
